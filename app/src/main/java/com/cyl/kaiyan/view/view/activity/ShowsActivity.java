...
import com.cyl.kaiyan.customview.CustomMediaController;
...
public class ShowsActivity extends AppCompatActivity implements MediaPlayer.OnInfoListener, MediaPlayer.OnBufferingUpdateListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //获得当前窗体对象
        Window window = ShowsActivity.this.getWindow();
        //设置当前窗体为全屏显示
    ...
    * */
    private void initData() {
        String video = getIntent().getStringExtra("url");//视频播放地址
        String title = getIntent().getStringExtra("text");//视频标题
