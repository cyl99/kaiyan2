...
public interface MyApi {
    ...
    /*  ----------------------------------------------------我是分割线-----------------------------------------------------------------*/
    String url = "http://baobab.wandoujia.com/api/v2/";

    String kaiurl = "http://baobab.wandoujia.com/api/v2/";
    String findUrl = "http://baobab.kaiyanapp.com/api/v4/";
    @GET("feed?num=2&udid=26868b32e808498db32fd51fb422d00175e179df&vc=83")
    Observable<EveryDayBean> initData();  //每日精选

    @GET("categories?udid=26868b32e808498db32fd51fb422d00175e179df&vc=83")
    Observable<List<FindMoreBean>> initDatafind(); //发现更多

    @GET("discovery/category")
    Observable<FindTwoBean> initDatafind_two();

    /*String kaiurl = "https://wanandroid.com/wxarticle/";
    @GET("chapters/json")
    Observable<FindMoreBean> initDatafind();*/
//http://baobab.wandoujia.com/api/v3/
    @GET("ranklist?num=10&strategy=%s&udid=26868b32e808498db32fd51fb422d00175e179df&vc=83")
    Observable<HotBean> initDataHot();
}
