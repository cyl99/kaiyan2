...
public class CenterLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE) {
                ...
                io.vov.vitamio.widget.CenterLayout.LayoutParams lp = (io.vov.vitamio.widget.CenterLayout.LayoutParams) child.getLayoutParams();
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof io.vov.vitamio.widget.CenterLayout.LayoutParams;
    }

    @Override
    protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return new io.vov.vitamio.widget.CenterLayout.LayoutParams(p);
    }
